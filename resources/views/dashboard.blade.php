<x-app-layout>
    <div class="flex items-center justify-between px-6 py-4 border-b border-[#e7ebf3] dark:border-gray-800 bg-white dark:bg-[#1a2230]">
        <div class="flex flex-col gap-1">
            <h1 class="text-2xl font-bold text-[#0d121b] dark:text-white tracking-tight">Bonjour, {{ Auth::user()->name }}</h1>
            <p class="text-[#4c669a] dark:text-gray-400 text-sm">Voici ce qui se passe dans votre département aujourd'hui.</p>
        </div>
        
        <div class="hidden sm:flex">
             <a href="{{ route('import.index') }}" class="flex items-center justify-center gap-2 rounded-lg bg-primary h-10 px-6 text-white text-sm font-bold shadow-sm hover:bg-blue-700 transition-colors">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="size-8 rounded bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-primary font-bold text-xs">CS</div>
                                            <span class="text-sm font-medium text-[#0d121b] dark:text-white">Computer Science 101</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-[#4c669a] dark:text-gray-400">Aujourd'hui</td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <button class="text-gray-400 hover:text-primary transition"><span class="material-symbols-outlined text-[20px]">visibility</span></button>
                                    </td>
                                </tr>
                                </tbody>
                        </table>
            ...
            <div class="space-y-8">
                <div class="flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <a href="{{ route('import.index') }}" class="group flex items-center p-4 bg-primary text-white rounded-xl shadow-lg shadow-blue-200 dark:shadow-none hover:shadow-xl hover:bg-blue-700 transition-all">
                        ...
                        <a href="{{ route('modules.index') }}" class="group flex items-center p-4 bg-white dark:bg-[#1a2230] border border-[#e7ebf3] dark:border-gray-800 rounded-xl hover:border-primary/50 dark:hover:border-primary/50 transition-all text-[#0d121b] dark:text-white">
                ...
                <div class="relative rounded-xl overflow-hidden h-40 group cursor-pointer border border-gray-200 dark:border-gray-700">
                    <div class="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style='background-image: url("https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=1000");'></div>
